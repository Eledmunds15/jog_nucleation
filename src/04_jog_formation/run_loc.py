...
INPUT_PATH = os.path.join(ROOT_DIR, '02_miniomize_dislo', 'output', 'dump')
...
def main():
    ...
    if rank == 0: os.makedirs(OUTPUT_DIR, exist_ok=True)
    ...
    L.write_dump('all', 'custom',os.path.join(OUTPUT_DIR, 'dump'), 'id', 'x', 'y', 'z', 'c_peratom') # Write a dumpfile containing atom positions and pot energies
